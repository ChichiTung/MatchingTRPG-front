...
`,[B("scrollbar",`
 ...
 `,[Tt({originalTransition:"background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)"})])]),fo=Object.assign(Object.assign({},he.props),{to:lt.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:"bottom-start"},widthMode:{type:String,default:"trigger"},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},childrenField:{type:String,default:"children"},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:"show"},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},onChange:[Function,Array],items:Array}),mo=re({name:"Select",props:fo,setup(e){const{mergedClsPrefixRef:n,mergedBorderedRef:o,namespaceRef:i,inlineThemeDisabled:a}=St(e),c=he("Select","-select",uo,co,e,n),f=O(e.defaultValue),l=ee(e,"value"),x=ht(l,f),w=O(!1),p=O(""),C=k(()=>{const{valueField:t,childrenField:u}=e,F=io(t,u);return yn(g.value,F)}),T=k(()=>ro(J.value,e.valueField,e.childrenField)),z=O(!1),m=ht(ee(e,"show"),z),R=O(null),A=O(null),S=O(null),{localeRef:y}=Ot("Select"),V=k(()=>{var t;return(t=e.placeholder)!==null&&t!==void 0?t:y.value.placeholder}),Y=vn(e,["items","options"]),q=[],N=O([]),G=O([]),X=O(new Map),te=k(()=>{const{fallbackOption:t}=e;if(t===void 0){const{labelField:u,valueField:F}=e;return $=>({[u]:String($),[F]:$})}return t===!1?!1:u=>Object.assign(t(u),{value:u})}),J=k(()=>G.value.concat(N.value).concat(Y.value)),h=k(()=>{const{filter:t}=e;if(t)return t;const{labelField:u,valueField:F}=e;return($,M)=>{if(!M)return!1;const I=M[u];if(typeof I=="string")return ot($,I);const P=M[F];return typeof P=="string"?ot($,P):typeof P=="number"?ot($,String(P)):!1}}),g=k(()=>{if(e.remote)return Y.value;{const{value:t}=J,{value:u}=p;return!u.length||!e.filterable?t:lo(t,h.value,u,e.childrenField)}});function _(t){const u=e.remote,{value:F}=X,{value:$}=T,{value:M}=te,I=[];return t.forEach(P=>{if($.has(P))I.push($.get(P));else if(u&&F.has(P))I.push(F.get(P));else if(M){const Z=M(P);Z&&I.push(Z)}}),I}const W=k(()=>{if(e.multiple){const{value:t}=x;return Array.isArray(t)?_(t):[]}return null}),j=k(()=>{const{value:t}=x;return!e.multiple&&!Array.isArray(t)?t===null?null:_([t])[0]||null:null}),H=gn(e),{mergedSizeRef:E,mergedDisabledRef:K,mergedStatusRef:r}=H;function v(t,u){const{onChange:F,"onUpdate:value":$,onUpdateValue:M}=e,{nTriggerFormChange:I,nTriggerFormInput:P}=H;F&&ae(F,t,u),M&&ae(M,t,u),$&&ae($,t,u),f.value=t,I(),P()}function L(t){const{onBlur:u}=e,{nTriggerFormBlur:F}=H;u&&ae(u,t),F()}function Q(){const{onClear:t}=e;t&&ae(t)}function se(t){const{onFocus:u,showOnFocus:F}=e,{nTriggerFormFocus:$}=H;u&&ae(u,t),$(),F&&de()}function Re(t){const{onSearch:u}=e;u&&ae(u,t)}function Te(t){const{onScroll:u}=e;u&&ae(u,t)}function be(){var t;const{remote:u,multiple:F}=e;if(u){const{value:$}=X;if(F){const{valueField:M}=e;(t=W.value)===null||t===void 0||t.forEach(I=>{$.set(I[M],I)})}else{const M=j.value;M&&$.set(M[e.valueField],M)}}}function me(t){const{onUpdateShow:u,"onUpdate:show":F}=e;u&&ae(u,t),F&&ae(F,t),z.value=t}function de(){K.value||(me(!0),z.value=!0,e.filterable&&Be())}function ne(){me(!1)}function we(){p.value="",G.value=q}const ue=O(!1);function Oe(){e.filterable&&(ue.value=!0)}function ve(){e.filterable&&(ue.value=!1,m.value||we())}function ge(){K.value||(m.value?e.filterable?Be():ne():de())}function ze(t){var u,F;!((F=(u=S.value)===null||u===void 0?void 0:u.selfRef)===null||F===void 0)&&F.contains(t.relatedTarget)||(w.value=!1,L(t),ne())}function Me(t){se(t),w.value=!0}function Pe(t){w.value=!0}function xe(t){var u;!((u=R.value)===null||u===void 0)&&u.$el.contains(t.relatedTarget)||(w.value=!1,L(t),ne())}function ye(){var t;(t=R.value)===null||t===void 0||t.focus(),ne()}function ie(t){var u;m.value&&(!((u=R.value)===null||u===void 0)&&u.$el.contains(Cn(t))||ne())}function d(t){if(!Array.isArray(t))return[];if(te.value)return Array.from(t);{const{remote:u}=e,{value:F}=T;if(u){const{value:$}=X;return t.filter(M=>F.has(M)||$.has(M))}else return t.filter($=>F.has($))}}function b(t){U(t.rawNode)}function U(t){if(K.value)return;const{tag:u,remote:F,clearFilterAfterSelect:$,valueField:M}=e;if(u&&!F){const{value:I}=G,P=I[0]||null;if(P){const Z=N.value;Z.length?Z.push(P):N.value=[P],G.value=q}}if(F&&X.value.set(t[M],t),e.multiple){const I=d(x.value),P=I.findIndex(Z=>Z===t[M]);if(~P){if(I.splice(P,1),u&&!F){const Z=Ie(t[M]);~Z&&(N.value.splice(Z,1),$&&(p.value=""))}}else I.push(t[M]),$&&(p.value="");v(I,_(I))}else{if(u&&!F){const I=Ie(t[M]);~I?N.value=[N.value[I]]:N.value=q}$e(),ne(),v(t[M],t)}}function Ie(t){return N.value.findIndex(F=>F[e.valueField]===t)}function Ue(t){m.value||de();const{value:u}=t.target;p.value=u;const{tag:F,remote:$}=e;if(Re(u),F&&!$){if(!u){G.value=q;return}const{onCreate:M}=e,I=M?M(u):{[e.labelField]:u,[e.valueField]:u},{valueField:P}=e;Y.value.some(Z=>Z[P]===I[P])||N.value.some(Z=>Z[P]===I[P])?G.value=q:G.value=[I]}}function qe(t){t.stopPropagation();const{multiple:u}=e;!u&&e.filterable&&ne(),Q(),u?v([],[]):v(null,null)}function Ge(t){!Ve(t,"action")&&!Ve(t,"empty")&&t.preventDefault()}function Ye(t){Te(t)}function _e(t){var u,F,$,M,I;switch(t.key){case" ":if(e.filterable)break;t.preventDefault();case"Enter":if(!(!((u=R.value)===null||u===void 0)&&u.isComposing)){if(m.value){const P=(F=S.value)===null||F===void 0?void 0:F.getPendingTmNode();P?b(P):e.filterable||(ne(),$e())}else if(de(),e.tag&&ue.value){const P=G.value[0];if(P){const Z=P[e.valueField],{value:Ee}=x;e.multiple&&Array.isArray(Ee)&&Ee.some(Qe=>Qe===Z)||U(P)}}}t.preventDefault();break;case"ArrowUp":if(t.preventDefault(),e.loading)return;m.value&&(($=S.value)===null||$===void 0||$.prev());break;case"ArrowDown":if(t.preventDefault(),e.loading)return;m.value?(M=S.value)===null||M===void 0||M.next():de();break;case"Escape":m.value&&(Sn(t),ne()),(I=R.value)===null||I===void 0||I.focus();break}}function $e(){var t;(t=R.value)===null||t===void 0||t.focus()}function Be(){var t;(t=R.value)===null||t===void 0||t.focusInput()}function Ze(){var t;m.value&&((t=A.value)===null||t===void 0||t.syncPosition())}be(),Fe(ee(e,"options"),be);const Xe={focus:()=>{var t;(t=R.value)===null||t===void 0||t.focus()},blur:()=>{var t;(t=R.value)===null||t===void 0||t.blur()}},Ae=k(()=>{const{self:{menuBoxShadow:t}}=c.value;return{"--n-menu-box-shadow":t}}),fe=a?Ke("select",void 0,Ae,e):void 0;return Object.assign(Object.assign({},Xe),{mergedStatus:r,mergedClsPrefix:n,mergedBordered:o,namespace:i,treeMate:C,isMounted:pn(),triggerRef:R,menuRef:S,pattern:p,uncontrolledShow:z,mergedShow:m,adjustedTo:lt(e),uncontrolledValue:f,mergedValue:x,followerRef:A,localizedPlaceholder:V,selectedOption:j,selectedOptions:W,mergedSize:E,mergedDisabled:K,focused:w,activeWithoutMenuOpen:ue,inlineThemeDisabled:a,onTriggerInputFocus:Oe,onTriggerInputBlur:ve,handleTriggerOrMenuResize:Ze,handleMenuFocus:Pe,handleMenuBlur:xe,handleMenuTabOut:ye,handleTriggerClick:ge,handleToggle:b,handleDeleteOption:U,handlePatternInput:Ue,handleClear:qe,handleTriggerBlur:ze,handleTriggerFocus:Me,handleKeydown:_e,handleMenuAfterLeave:we,handleMenuClickOutside:ie,handleMenuScroll:Ye,handleMenuKeydown:_e,handleMenuMousedown:Ge,mergedTheme:c,cssVars:a?void 0:Ae,themeClass:fe==null?void 0:fe.themeClass,onRender:fe==null?void 0:fe.onRender})},render(){return s("div",{class:`${this.mergedClsPrefix}-select`},s(bn,null,{default:()=>[s(mn,null,{default:()=>s(oo,{ref:"triggerRef",inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e,n;return[(n=(e=this.$slots).arrow)===null||n===void 0?void 0:n.call(e)]}})}),s(wn,{ref:"followerRef",show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===lt.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?"target":void 0,minWidth:"target",placement:this.placement},{default:()=>s(Rt,{name:"fade-in-scale-up-transition",appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e,n,o;return this.mergedShow||this.displayDirective==="show"?((e=this.onRender)===null||e===void 0||e.call(this),kn(s(Qn,Object.assign({},this.menuProps,{ref:"menuRef",onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,(n=this.menuProps)===null||n===void 0?void 0:n.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:"medium",renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[(o=this.menuProps)===null||o===void 0?void 0:o.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange}),{empty:()=>{var i,a;return[(a=(i=this.$slots).empty)===null||a===void 0?void 0:a.call(i)]},action:()=>{var i,a;return[(a=(i=this.$slots).action)===null||a===void 0?void 0:a.call(i)]}}),this.displayDirective==="show"?[[xn,this.mergedShow],[vt,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[vt,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}});export{mo as _};
