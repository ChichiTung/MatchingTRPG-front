import{b as H,aI as t,l as o,e as C,g as b,ah as V,O as W,ab as F,u as I,h as z,p as q,i as D,q as f}from"./router-06f85e02.js";import{d as K,c as x,h as N}from"./plugin-vueexport-helper-e229d7b0.js";const A={thPaddingSmall:"6px",thPaddingMedium:"12px",thPaddingLarge:"12px",tdPaddingSmall:"6px",tdPaddingMedium:"12px",tdPaddingLarge:"12px"},G=e=>{const{dividerColor:r,cardColor:l,modalColor:n,popoverColor:a,tableHeaderColor:s,tableColorStriped:i,textColor1:d,textColor2:c,borderRadius:g,fontWeightStrong:h,lineHeight:p,fontSizeSmall:m,fontSizeMedium:v,fontSizeLarge:u}=e;return Object.assign(Object.assign({},A),{fontSizeSmall:m,fontSizeMedium:v,fontSizeLarge:u,lineHeight:p,borderRadius:g,borderColor:t(l,r),borderColorModal:t(n,r),borderColorPopover:t(a,r),tdColor:l,tdColorModal:n,tdColorPopover:a,tdColorStriped:t(l,i),tdColorStripedModal:t(n,i),tdColorStripedPopover:t(a,i),thColor:t(l,s),thColorModal:t(n,s),thColorPopover:t(a,s),thTextColor:d,tdTextColor:c,thFontWeight:h})},J={name:"Table",common:H,self:G},Q=J,U=o([C("table",`
 ...
 `),o("td",`
 background-color: var(--n-td-color-popover);
 `)]))]),X=Object.assign(Object.assign({},z.props),{bordered:{type:Boolean,default:!0},bottomBordered:{type:Boolean,default:!0},singleLine:{type:Boolean,default:!0},striped:Boolean,singleColumn:Boolean,size:{type:String,default:"medium"}}),oo=K({name:"Table",props:X,setup(e){const{mergedClsPrefixRef:r,inlineThemeDisabled:l,mergedRtlRef:n}=I(e),a=z("Table","-table",U,Q,e,r),s=q("Table",n,r),i=x(()=>{const{size:c}=e,{self:{borderColor:g,tdColor:h,tdColorModal:p,tdColorPopover:m,thColor:v,thColorModal:u,thColorPopover:P,thTextColor:S,tdTextColor:M,borderRadius:k,thFontWeight:R,lineHeight:T,borderColorModal:B,borderColorPopover:$,tdColorStriped:y,tdColorStripedModal:L,tdColorStripedPopover:w,[f("fontSize",c)]:O,[f("tdPadding",c)]:_,[f("thPadding",c)]:j},common:{cubicBezierEaseInOut:E}}=a.value;return{"--n-bezier":E,"--n-td-color":h,"--n-td-color-modal":p,"--n-td-color-popover":m,"--n-td-text-color":M,"--n-border-color":g,"--n-border-color-modal":B,"--n-border-color-popover":$,"--n-border-radius":k,"--n-font-size":O,"--n-th-color":v,"--n-th-color-modal":u,"--n-th-color-popover":P,"--n-th-font-weight":R,"--n-th-text-color":S,"--n-line-height":T,"--n-td-padding":_,"--n-th-padding":j,"--n-td-color-striped":y,"--n-td-color-striped-modal":L,"--n-td-color-striped-popover":w}}),d=l?D("table",x(()=>e.size[0]),i,e):void 0;return{rtlEnabled:s,mergedClsPrefix:r,cssVars:l?void 0:i,themeClass:d==null?void 0:d.themeClass,onRender:d==null?void 0:d.onRender}},render(){var e;const{mergedClsPrefix:r}=this;return(e=this.onRender)===null||e===void 0||e.call(this),N("table",{class:[`${r}-table`,this.themeClass,{[`${r}-table--rtl`]:this.rtlEnabled,[`${r}-table--bottom-bordered`]:this.bottomBordered,[`${r}-table--bordered`]:this.bordered,[`${r}-table--single-line`]:this.singleLine,[`${r}-table--single-column`]:this.singleColumn,[`${r}-table--striped`]:this.striped}],style:this.cssVars},this.$slots)}});export{oo as _};
